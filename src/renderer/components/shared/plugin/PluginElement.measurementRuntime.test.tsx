...
vi.mock(
  '@utils/plugin/layout/pluginElementMeasurement',
  async (importOriginal) => ({
    ...(await importOriginal<
      typeof import('@utils/plugin/layout/pluginElementMeasurement')
    >()),
    measureConnectedPluginElement: measurementMocks.measure,
  }),
);

vi.mock('@utils/plugin/interactions/pluginDomInteractions', () => ({
