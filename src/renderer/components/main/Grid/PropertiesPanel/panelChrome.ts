...
// 프레임이 재질을 소유하고, 페이지 전환 시 콘텐츠 레이어만 슬라이드
// 상주 풀하이트 표면이라 라이브 블러 금지 — 고알파 솔리드 + 인셋 링으로 근사
export const SIDE_PANEL_FRAME_CLASS =
  'absolute right-0 top-0 bottom-0 w-[240px] bg-glass-panel-solid shadow-elevation-panel z-30';
