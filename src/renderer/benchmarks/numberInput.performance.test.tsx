...
const benchmarkDescribe =
  process.env.DMN_NUMBER_INPUT_BENCHMARK === '1' ? describe : describe.skip;
const OUTPUT_PATH =
  process.env.DMN_BENCHMARK_OUTPUT ??
  'benchmarks/results/base-04-number-input-latest.json';
...
benchmarkDescribe('BASE-04 NumberInput 성능', () => {
