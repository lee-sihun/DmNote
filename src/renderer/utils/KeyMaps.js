export const keyMaps = {
  ...
  // 넘패드
  Numpad0: { browserKey: '0', globalKey: 'INS', displayName: 'Ins' },
  Numpad1: { browserKey: '1', globalKey: 'END', displayName: 'End' },
  Numpad2: { browserKey: '2', globalKey: 'DOWN ARROW', displayName: '↓' },
  Numpad3: { browserKey: '3', globalKey: 'PAGE DOWN', displayName: 'PgDn' },
  Numpad4: { browserKey: '4', globalKey: 'LEFT ARROW', displayName: '←' },
  Numpad5: { browserKey: '5', globalKey: 'NUMPAD CLEAR', displayName: 'Clr' },
  Numpad6: { browserKey: '6', globalKey: 'RIGHT ARROW', displayName: '→' },
  Numpad7: { browserKey: '7', globalKey: 'HOME', displayName: 'Home' },
  Numpad8: { browserKey: '8', globalKey: 'UP ARROW', displayName: '↑' },
  Numpad9: { browserKey: '9', globalKey: 'PAGE UP', displayName: 'PgUp' },
