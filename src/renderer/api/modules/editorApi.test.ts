...
describe('editorCommitRaw semantic op protocol', () => {
  ...
  it.each([
    ...
    ['key', { counterFontFamily: '' }],
    ['stat', { counterFontFamily: '  Raw Counter Family  ' }],
    ...
    ['key', { displayText: '' }],
    ['stat', { displayText: '  Raw label  ' }],
    ['graph', { displayText: 'Graph' }],
    ['knob', { displayText: 'Knob' }],
    ['key', { className: '' }],
    ['stat', { className: '  Raw class  ' }],
    ['graph', { className: 'graph-class' }],
    ['knob', { className: 'knob-class' }],
    ['key', { borderWidth: 0 }],
    ['stat', { borderWidth: 20 }],
    ['graph', { borderRadius: 100 }],
    ['knob', { borderRadius: 999 }],
    ['key', { shadow: { color: '  raw shadow  ' } }],
    ['stat', { shadow: { offsetX: -100 } }],
    ['knob', { activeShadow: { offsetY: 100 } }],
    ['key', { activeShadow: { blur: 100 } }],
    ['stat', { shadowEnabled: false }],
    ['key', { fontSize: 8 }],
    ['knob', { fontSize: 72 }],
    ['key', { noteGlowSize: 0 }],
    ['key', { noteGlowSize: 20.5 }],
    ['key', { noteGlowSize: 50 }],
    ['key', { noteOffsetX: null }],
    ['key', { noteOffsetX: -500 }],
    ['key', { noteOffsetX: 0 }],
    ['key', { noteOffsetY: 500 }],
    ['key', { noteWidth: null }],
    ['key', { noteWidth: 0.1 }],
    ['key', { noteBorderWidth: 0 }],
  ...
  it.each([
    ...
    ['key', { borderWidth: -0.1 }],
    ['stat', { borderWidth: 20.1 }],
    ['graph', { borderWidth: Number.POSITIVE_INFINITY }],
    ['key', { borderRadius: -0.1 }],
    ['graph', { borderRadius: 100.1 }],
    ['knob', { borderRadius: 999.1 }],
    ['key', { fontSize: 7.9 }],
    ['stat', { fontSize: 72.1 }],
    ['graph', { fontSize: '14' }],
    ['knob', { borderWidth: 1, borderRadius: 2 }],
    ['graph', { shadow: { blur: 10 } }],
    ['stat', { activeShadow: { blur: 10 } }],
    ['key', { shadow: { color: '' } }],
    ['key', { shadow: { offsetX: -100.1 } }],
    ['knob', { activeShadow: { offsetY: Infinity } }],
    ['key', { shadow: { blur: 100.1 } }],
    ['key', { shadow: { blur: 10, color: '#000' } }],
    ['key', { shadowEnabled: 1 }],
    ['key', { shadowEnabled: true, shadow: { blur: 10 } }],
    ['stat', { noteGlowSize: 20 }],
    ['graph', { noteGlowSize: 20 }],
    ['knob', { noteGlowSize: 20 }],
    ['key', { noteGlowSize: -0.1 }],
    ['key', { noteGlowSize: 50.1 }],
    ['key', { noteGlowSize: Number.POSITIVE_INFINITY }],
    ['key', { noteGlowSize: '20' }],
    ['key', { noteGlowSize: 20, noteGlowEnabled: true }],
    ['stat', { noteOffsetX: 0 }],
    ['graph', { noteWidth: null }],
    ['knob', { noteBorderWidth: 2 }],
    ['key', { noteOffsetX: -500.1 }],
    ['key', { noteOffsetY: 500.1 }],
    ['key', { noteOffsetX: Number.NaN }],
    ['key', { noteWidth: 0 }],
    ['key', { noteWidth: Number.POSITIVE_INFINITY }],
    ['key', { noteBorderWidth: -0.1 }],
    ['key', { noteBorderWidth: 20.1 }],
    ['key', { noteBorderRadius: 0.9 }],
    ...
    ['graph', { counterFontFamily: 'Counter Family' }],
    ['knob', { counterFontFamily: '' }],
    ['key', { counterFontFamily: null }],
    ['stat', { counterFontFamily: 'Counter', counterFontItalic: true }],
    ['graph', { counterStrokeIdle: '#ffffff' }],
    ['stat', { counterStrokeActive: '#ffffff' }],
    ['key', { counterStrokeIdle: null }],
