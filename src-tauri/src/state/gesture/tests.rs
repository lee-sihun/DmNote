use super::*;
use crate::models::{
    EditorBoundsV1, EditorElementGroupTargetV1, EditorElementPropertyPatchV1, EditorElementTypeV1,
    EditorFrozenKeySlotV1, EditorGroupUpdateV1, EditorOpV1, EditorPatchV1, EditorTargetGroupV1,
...
fn gesture_property_and_key_slot_wires_reject_unknown_nested_keys() {
    ...
    let literal_properties = [
        ...
        (
            EditorElementTypeV1::Key,
            EditorElementPropertyPatchV1::Shadow(crate::models::EditorShadowLeafPatchV1::Blur(8.5)),
