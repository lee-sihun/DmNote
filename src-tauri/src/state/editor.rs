...
use crate::{
    ...
    models::{
        ...
        KnobPosition, ReactiveSpritePosition, SpriteTransform, StatPosition,
...
mod tests {
    ...
    use crate::models::{
        ...
        ReactiveSpritePosition, SpriteActivation, SpriteImageMetrics, SpritePose,
        SpriteReferenceNaturalSize, StatPosition, StatType,
    };
