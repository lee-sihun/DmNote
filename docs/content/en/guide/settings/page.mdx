...
This resets keys and placements, saved plugin display-element placements,
counters, custom tabs, layer groups, per-tab note and CSS overrides, and note,
background, and custom CSS visual options.

Installed plugins and their non-layout storage, language, shortcuts, and
update or startup options are not removed.
...
<Callout type="warning">
  Resetting data cannot be undone. Save important settings as presets
  beforehand.
</Callout>
