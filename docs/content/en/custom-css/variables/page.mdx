...
| `--sprite-transform`  | Replacement transform for the resolved pose | `<transform>`  | `rotate(15deg) scale(1.2)` |
| `--sprite-transition` | Replacement transition for the pose change  | `<transition>` | `transform 120ms ease-out` |
