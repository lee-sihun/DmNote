...
- Added Simplified and Traditional Chinese Interface Support
  - @LSVoiid contributed [Traditional Chinese interface translation](https://github.com/DmNote-App/DmNote/pull/26). 🎉
  - @mohong2 contributed [Simplified Chinese interface and README translation](https://github.com/DmNote-App/DmNote/pull/28). 🎉
...
- Added official macOS (arm64) support
  - Starting from this version, macOS is officially supported
